...
ReplicationCommand *replication_parse_result;
...
%type <str>	base_backup_opt

%type <uintval>	opt_timeline
//%type <list>	plugin_options plugin_opt_list
//%type <defelt>	plugin_opt_elem
//%type <node>	plugin_opt_arg
%type <str>	plugin_options plugin_opt_list
...
base_backup:
			K_BASE_BACKUP base_backup_opt_list
				{
					ReplicationCommand *cmd = MakeReplCommand(REPL_BASE_BACKUP);
					//cmd->options = $2;
					$$ = cmd;
				}
			;
			...
			K_CREATE_REPLICATION_SLOT IDENT K_PHYSICAL
				{
					...
					cmd->slotname = $2;
					$$ = (Node *) cmd;*/
					$$ = MakeReplCommand(REPL_CREATE_SLOT);
				}
			...
			K_DROP_REPLICATION_SLOT IDENT
				{
					...
					cmd->slotname = $2;
					$$ = (Node *) cmd;*/
					$$ = MakeReplCommand(REPL_DROP_SLOT);
				}
			;
			...
			K_START_REPLICATION opt_slot opt_physical RECPTR opt_timeline
				{
					...
					cmd->timeline = $5;
					$$ = (Node *) cmd;*/
					ReplicationCommand *cmd = MakeReplCommand(REPL_START_PHYSICAL);
					cmd->slotname = $2;
					cmd->startpoint = $4;
					cmd->timeline = $5; 
					$$ = cmd;
			...
			K_START_REPLICATION K_SLOT IDENT K_LOGICAL RECPTR plugin_options
				{
					...
					cmd->options = $6;
					$$ = (Node *) cmd;*/
					$$ = MakeReplCommand(REPL_START_LOGICAL);
				}
			;
/*
 * TIMELINE_HISTORY %d
			...
			K_TIMELINE_HISTORY UCONST
				{
					...
					cmd = MakeReplCommand(REPL_TIMELINE);
					cmd->timeline = $2;
